...
import com.shopin.commonlibrary.core.AppConfig;
...
public class FileUtil {
    ...
    /**
     * @param goodsNo 当前使用商品号 和 图片类型
     * @param picType   0代表窗口图，1代表客观图
     * @return
     * @brief 生成图片ZIP包的文件名，通过因素和类型生成
     */
    public static String createTaskId(String goodsNo, String picType) {
        return EncryptUtil.MD5Encode(goodsNo + picType, AppConfig.ENCODING);
    }
