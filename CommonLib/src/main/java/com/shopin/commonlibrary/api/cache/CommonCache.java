package com.shopin.commonlibrary.api.cache;
...
public interface CommonCache {
    ...
    Observable<Reply<WrapAddressApiEntity>> getAddress(Observable<WrapAddressApiEntity> service);

    @LifeCache(duration = 1, timeUnit = TimeUnit.DAYS)
    Observable<Reply<BaseEntity<List<Mall>>>> getShopInfo(Observable<BaseEntity<List<Mall>>> service);
